...
//#endregion
//#region node_modules/.pnpm/srvx@0.12.4/node_modules/srvx/dist/adapters/cloudflare.mjs
var FastURL = URL;
    ...
    if (url.pathname.includes("%"))
      try {
        ...
        if (pathname !== url.pathname)
          url = new FastURL(
            `${url.protocol}//${url.host}${pathname}${url.search}`,
          );
      } catch {
  ...
  return Object.assign(
    handlerWithFetch(
      input.middleware?.length
        ? composeHandler(input.middleware, handler)
        : handler,
    ),
    input,
  );
