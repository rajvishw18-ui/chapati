...
//#region node_modules/.pnpm/@vercel+analytics@2.0.1_react@19.2.8/node_modules/@vercel/analytics/dist/react/index.mjs
...
function inject(props = { debug: true }, confString) {
  ...
  initQueue();
  if (beforeSend)
    (_a = window.va) == null || _a.call(window, "beforeSend", beforeSend);
...
function getBasePath() {
  if (
    ...
    typeof processModule.env === "undefined"
  )
    return;
