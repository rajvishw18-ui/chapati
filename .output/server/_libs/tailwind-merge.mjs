...
var isNamedContainerQuery = (value) =>
  ...
  ((value[10] === "/" && value[11] !== void 0) ||
    (value[11] === "s" &&
      value[16] !== void 0 &&
      value.startsWith("-size/", 10)) ||
    (value[11] === "n" &&
      value[18] !== void 0 &&
      value.startsWith("-normal/", 10)));
...
var isArbitraryWeight = (value) =>
  getIsArbitraryValue(value, isLabelWeight, isAny);
var isArbitraryFamilyName = (value) =>
...
var isArbitraryVariableWeight = (value) =>
...
var getDefaultConfig = () => {
  ...
  return {
    ...
    classGroups: {
       ...
       */
      "align-items": [
        { items: [...scaleAlignSecondaryAxis(), { baseline: ["", "last"] }] },
      ],
      /**
       * Align Self
