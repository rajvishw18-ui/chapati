...
import {
  ...
  r as require_react,
} from "../react+tanstack__react-query.mjs";
...
var nullReplaceEqualDeep = (prev, next) =>
...
function parseSegment(
  path,
  start,
  output = /* @__PURE__ */ new Uint16Array(6),
) {
...
function sortTreeNodes(node) {
  ...
  if (node.static)
    for (const child of node.static.values()) sortTreeNodes(child);
...
function getNodeMatch(path, parts, segmentTree, fuzzy) {
  ...
  while (stack.length) {
    ...
    if (node.kind === 2 && node.route && !isFrameMoreSpecific(bestMatch, frame))
      continue;
    if (node.parse) {
    ...
    if (node.wildcard)
      for (let i = node.wildcard.length - 1; i >= 0; i--) {
        ...
        if (prefix) {
          ...
          if (
            !(
              segment.caseSensitive ? part : (lowerPart ??= part.toLowerCase())
            ).startsWith(prefix)
          )
            continue;
        }
        if (suffix) {
          ...
          if ((segment.caseSensitive ? end : end.toLowerCase()) !== suffix)
            continue;
        }
        stack.push({
          node: segment,
...
var getNotFoundBoundaryIndex = (inner, err) => {
  ...
  for (let i = startIndex; i >= 0; i--) {
    ...
    if (inner.router.looseRoutesById[match.routeId].options.notFoundComponent)
      return i;
  }
...
async function loadMatches(arg) {
  ...
  const baseMaxIndexExclusive =
    inner.firstBadMatchIndex ?? inner.matches.length;
  const boundaryIndex =
  ...
  const notFoundToThrow =
    firstNotFound ??
    (beforeLoadNotFound && !inner.preload ? beforeLoadNotFound : void 0);
  let headMaxIndex =
    inner.firstBadMatchIndex !== void 0
  ...
  if (notFoundToThrow) {
    ...
    const defaultNotFoundComponent =
      inner.router.options?.defaultNotFoundComponent;
...
var RouterCore = class {
  ...
  constructor(options, getStoreConfig) {
              ...
              const nextParams =
                maskParams === false || maskParams === null
                  ...
                  : (maskParams ?? true) === true
                    ...
                    : Object.assign(
                        params,
                        functionalUpdate(maskParams, params),
                      );
              maskedDest = {
                from: opts.from,
                ...maskProps,
    ...
    this.resolveRedirect = (redirect) => {
      ...
      if (!redirect.options.href || redirect.options._builtLocation) {
        const location =
          ...
          this.buildLocation(redirect.options);
    ...
    this.clearCache = (opts) => {
      ...
      if (filter !== void 0)
        this.stores.setCached(
          this.stores.cachedMatches.get().filter((m) => !filter(m)),
        );
    ...
    this.matchRoute = (location, opts) => {
      ...
      const baseLocation = (
        opts?.pending === void 0 ? !this.stores.isLoading.get() : opts.pending
      )
        ? this.latestLocation
        : this.stores.resolvedLocation.get() || this.stores.location.get();
  ...
  matchRoutesInternal(next, opts) {
    ...
    for (let index = 0; index < matchedRoutes.length; index++) {
      ...
      const loaderDeps =
        route.options.loaderDeps?.({ search: preMatchSearch }) ?? "";
    ...
    for (let index = 0; index < matches.length; index++) {
      ...
      if (!existingMatch) {
        ...
        if (route.options.context) {
          ...
          match.__routeContext =
            route.options.context(contextFnContext) ?? void 0;
        }
        match.context = {
          ...parentContext,
          ...match.__routeContext,
...
function applySearchMiddleware({
  ...
  return buildMiddlewareChain(destRoutes)(
    search,
    dest,
          ...
          try {
            ...
            if (meta && validated) {
              for (const key in validated)
                if (!(key in result))
                  (meta.defaulted ||= /* @__PURE__ */ new Map()).set(
                    key,
                    validated[key],
                  );
            }
...
var BaseRoute = class {
  ...
  constructor(options) {
    this.init = (opts) => {
      ...
      const fullPath =
        id === "__root__" ? "/" : joinPaths([this.parentRoute.fullPath, path]);
      this._path = path;
      this._id = id;
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated()
    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, {
        children,
      })
    : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, {
        children: fallback,
...
function useStore(atom, selector, compare = defaultCompare) {
  ...
  const boundGetSnapshot = (0, import_react.useCallback)(
    () => atom?.get(),
    [atom],
  );
...
function useMatch(opts) {
  ...
  const nearestMatchId = import_react.useContext(
      ...
      if (activeOptions?.includeSearch ?? true) {
        if (currentLocation.search !== next.search) {
          ...
          const nextSearchEmpty =
            !next.search ||
            (typeof next.search === "object" && !hasKeys(next.search));
                        ...
                        resolvedNoSsr || matchState._displayPending
                          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              ClientOnly,
                              {
                                fallback: pendingElement,
                                children: /* @__PURE__ */ (0,
                                import_jsx_runtime.jsx)(MatchInner, {
                                  matchId,
                                }),
                              },
                            )
...
var MatchInner = import_react.memo(function MatchInnerImpl({ matchId }) {
  ...
  };
  {
    ...
    const remountDeps = (
      router.routesById[routeId].options.remountDeps ??
...
var Outlet = import_react.memo(function OutletImpl() {
  ...
  const nextMatch = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Match, {
...
function Matches() {
  ...
  const inner = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SafeFragment, {
    ...
    children: [
      false,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MatchesInner, {}),
    ],
  });
  return router.options.InnerWrap
    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(router.options.InnerWrap, {
        children: inner,
      })
    : inner;
}
...
function RouterContextProvider({ router, children, ...rest }) {
  ...
  const provider = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  ...
  if (router.options.Wrap)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(router.options.Wrap, {
      children: provider,
    });
  return provider;
}
  ...
  switch (asset.tag) {
    ...
    case "link":
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("link", {
        ...
        precedence:
          attrs?.precedence ??
          (attrs?.rel === "stylesheet" ? "default" : void 0),
        nonce,
        suppressHydrationWarning: true,
      });
    case "style":
 ...
 * LICENSE file in the root directory of this source tree.
 */
var require_react_dom_server_edge_production = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    var React = require_react();
...
var renderRouterToStream = async ({
  request,
  router,
  responseHeaders,
  children,
  ...
  if (typeof import_server_edge.default.renderToPipeableStream === "function") {
    ...
    const destroyError = (reason) =>
      reason === void 0 ? void 0 : toError(reason);
