...
var defaultStreamHandler = defineHandlerCallback(
  ({ request, router, responseHeaders }) =>
    renderRouterToStream({
      ...
      router,
      responseHeaders,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StartServer, {
        router,
      }),
    }),
);
...
var kEventResErrHeaders = /* @__PURE__ */ Symbol.for(
...
function createMemoryHistory(opts = { initialEntries: ["/"] }) {
  ...
  const states = entries.map((_entry, index) =>
    assignKeyAndIndex(index, void 0),
  );
...
function y$1(e) {
  ...
  for (let a = 0, s = e.length; a < s; a++)
    ((n = dn(e[a])), n && ((r += e.slice(t, a) + n), (t = a + 1)));
...
typeof globalThis != "undefined"
  ...
  : typeof window != "undefined"
    ...
    : typeof self != "undefined"
      ...
      : typeof globalthis_default != "undefined" &&
        Object.defineProperty(globalthis_default, U, {
          value: j$1,
          configurable: !0,
          writable: !1,
          enumerable: !1,
  ...
  let e = [],
    ...
    i = (l, g, S, d) => {
      for (g = 0, S = e.length; g < S; g++)
        ((d = e[g]),
          !t && g === S - 1 ? l[n ? "return" : "throw"](d) : l.next(d));
    },
    u = (l, g) => (
      t && ((g = a++), (r[g] = l)),
      i(l),
...
function D$1(e, r) {
  ...
  return t.type === 1
    ? t.value
    : c$1(26, t.value, r, o$1, o$1, o$1, o$1, o$1, o$1, o$1, o$1, o$1);
}
function tr(e) {
  let r = rr(e, xt);
  return r.type === 1
...
async function On(e, r, t) {
  ...
  for (let a = 0, s = t.length; a < s; a++)
    a in t ? (n[a] = await N$1(e, r, t[a])) : (n[a] = 0);
  return n;
}
...
async function Fr(e, r, t) {
  ...
  return (
    C in t &&
      (a.push(I(e.base, C)), s.push(je(tr(e.base), await N$1(e, r, Xe(t))))),
    v$1 in t &&
      (a.push(I(e.base, v$1)), s.push(Ye(nr(e.base), await N$1(e, r, er(t))))),
...
async function Fn(e, r, t, n) {
  let a = [],
    s = [];
  for (let [i, u] of n.entries())
    (a.push(await N$1(e, r, i)), s.push(await N$1(e, r, u)));
  ...
  if (a)
    for (let s = 0, i = a.length; s < i; s++) {
      ...
      if (u.parse.async && u.test(n))
        return ce(t, u.tag, await u.parse.async(n, new Dr(e, r), { id: t }));
    }
  return o$1;
}
...
function Kt(e, r, t, n) {
  let a = t.k;
  if (a.length > 0)
    for (let i = 0, u = t.v, l = a.length; i < l; i++) Xn(e, r, n, a[i], u[i]);
  return n;
}
function Qn(e, r, t) {
...
function fo(e, r, t) {
  ...
  if (n) {
    ...
    for (let s = 0, i = n.length; s < i; s++) {
      let u = n[s];
      if (u.tag === a)
        return b(e, t.i, u.deserialize(t.s, new Br(e, r), { id: t.i }));
    }
  }
  throw new Q$1(t.c);
}
...
function rn(e, r, t, n) {
  return t
    ? F$1(e.base, t)
      ? (w$1(e.base, r), be(e, r, n, m$1(e, t.i)), "")
      : f$1(e, t)
    : "";
}
function jo(e, r) {
...
function tn(e, r, t, n) {
  if (typeof t == "string") {
    let a = Number(t),
      s = (a >= 0 && a.toString() === t) || Lr(t);
    if (F$1(e.base, n)) {
      let i = m$1(e, n.i);
      return (
        w$1(e.base, r.i),
        s && a !== a ? Yr(e, r.i, t, i) : be(e, r.i, s ? t : '"' + t + '"', i),
        ""
      );
    }
    return de$1(t)
...
function cn(e, r, t) {
  ...
  if (a > 0) {
    ...
    for (let u = 1, l = i; u < a; u++)
      ((l = tn(e, r, n[u], s[u])), (i += (l && i && ",") + l));
...
function Wo(e, r, t, n, a) {
  let s = e.base,
    i = f$1(e, a),
    u = Number(n),
    l = (u >= 0 && u.toString() === n) || Lr(n);
  if (F$1(s, a))
    l && u !== u ? Yr(e, r.i, n, i) : be(e, r.i, l ? n : '"' + n + '"', i);
  else {
    let g = s.assignments;
    ((s.assignments = t),
      l && u !== u ? Yr(e, r.i, n, i) : be(e, r.i, l ? n : '"' + n + '"', i),
...
function Xo(e, r) {
  ...
  if (a > 0) {
    ...
    for (let d = 1, G = S; d < a; d++)
      ((G = on(e, s, n[d], g[d], u)), (S += (G && S && ",") + G));
    (l.stack.pop(), S && (t += "([" + S + "])"));
  }
  return (
    i.t === 26 && (w$1(l, i.i), (t = "(" + f$1(e, i) + "," + t + ")")),
    t
  );
}
function Qo(e, r) {
...
function ca(e, r) {
  ...
  return (
    r.f.t !== 4 &&
      (w$1(e.base, r.f.i), (t = "(" + f$1(e, r.f) + ","), (n = !0)),
    (t += ae(e, r.i, "(" + Et + ")(" + m$1(e, r.f.i) + ")")),
    n && (t += ")"),
    t
  );
}
...
function Sa(e, r) {
  let t = r.a[0],
    ...
    a = e.base,
    s = "";
  (t.t !== 4 && (w$1(a, t.i), (s += "(" + f$1(e, t))),
    n.t !== 4 && (w$1(a, n.i), (s += (s ? "," : "(") + f$1(e, n))),
    s && (s += ","));
...
function Na(e, r) {
  ...
  if (n > 0) {
    e.base.stack.push(a);
    let s = an(e, a, 0, t[0]);
    for (let i = 1, u = s; i < n; i++)
      ((u = an(e, a, i, t[i])), (s += (u && s && ",") + u));
    if ((e.base.stack.pop(), s))
      return (
        "{__SEROVAL_SEQUENCE__:!0,v:[" + s + "],t:" + r.s + ",d:" + r.l + "}"
      );
  }
...
function $r(e, r, t) {
  let n = Object.entries(t),
    ...
    s = [];
  for (let i = 0, u = n.length; i < u; i++)
    (a.push(y$1(n[i][0])), s.push(E$1(e, r, n[i][1])));
  return (
    C in t && (a.push(I(e.base, C)), s.push(je(tr(e.base), E$1(e, r, Xe(t))))),
    v$1 in t &&
      (a.push(I(e.base, v$1)),
      s.push(Ye(nr(e.base), E$1(e, r, e.type === 1 ? re$1() : er(t))))),
    P$1 in t && (a.push(I(e.base, P$1)), s.push(X(t[P$1]))),
    R in t && (a.push(I(e.base, R)), s.push(t[R] ? J : Z)),
    {
      k: a,
...
function _a(e, r, t, n) {
  let a = _r(e.base, {});
  return (
    e.type === 2 && (et(e), n.then(ha.bind(e, a, r), za.bind(e, a, r))),
    _t(e.base, t, a)
  );
}
function ka(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.sync && u.test(n))
      return ce(t, u.tag, u.parse.sync(n, new Hr(e, r), { id: t }));
  }
  return o$1;
}
function Da(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    ...
    if (u.parse.stream && u.test(n))
      return ce(t, u.tag, u.parse.stream(n, new Jr(e, r), { id: t }));
  }
  return o$1;
}
function Sn(e, r, t, n) {
...
function mn(e) {
  ...
  for (let r = 0, t = e.state.cleanups.length; r < t; r++)
    e.state.cleanups[r]();
}
function Qr(e, r, t) {
  try {
...
async function N(e, r) {
  try {
    let a = await r.read();
    a.done
      ? (e.return(a.value), r.releaseLock())
      : (e.next(a.value), await N(e, r));
  } catch (a) {
    e.throw(a);
  }
}
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } =
    await import("../_tanstack-start-manifest_v-DBt_smoC.mjs");
...
function mergeHeaders(...headers) {
  return headers.reduce((acc, header) => {
    ...
    for (const [key, value] of headersInstance.entries())
      if (key === "set-cookie")
        splitSetCookieString(value).forEach((cookie) =>
      ...
      let res = await (async () => {
        if (
          ...
          if (typeof serializedContext === "string")
            try {
              const deserializedContext = Ou(JSON.parse(serializedContext), {
...
function getStringAttr(attrs, name, fallbackName) {
  const value =
    attrs?.[name] ?? (fallbackName ? attrs?.[fallbackName] : void 0);
...
function collectStaticHintsFromManifest(manifest, matchedRoutes) {
  ...
  for (const route of matchedRoutes) {
    ...
    for (const link of routeManifest.css ?? []) {
      ...
      if (resolvedLink.crossOrigin !== void 0)
...
function getResponseLinkHeaderEntries(opts) {
  ...
  try {
    ...
    for (const entry of opts.entries)
      if (opts.filter(entry)) links.push(entry.link);
    return links;
  } catch (err) {
      ...
      route.preloads = await Promise.all(
        route.preloads.map(async (link) => {
          const result = await transformScript(
            resolveManifestAssetLink(link).href,
          );
...
function warmupFinalManifest(opts) {
  if (!opts.enabled || opts.handlerDefaultInlineCss === void 0 || !opts.cache)
    return;
...
var ServerFunctionSerializationAdapter = createSerializationAdapter({
  ...
  fromSerializable: ({ functionId }) => {
    const fn = async (opts, signal) => {
      return (
        await (
          await getServerFnById(functionId, { origin: "client" })
        )(opts ?? {}, signal)
      ).result;
    };
    return fn;
...
var getCachedBaseManifest = createCachedBaseManifestLoader(() =>
  getStartManifest(),
);
...
function createStartHandler(cbOrOptions) {
  ...
  finalManifestResolver.warmup({
    getBaseManifest: () => getBaseManifest(void 0),
  });
...
async function handleServerRoutes({
  ...
  if (server?.handlers && isExactMatch) {
    ...
    isHeadFallback =
      requestMethod === "HEAD" && handler !== void 0 && !handlers["HEAD"];
    if (handler) {
