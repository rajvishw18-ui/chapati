...
const en: Dict = {
  ...
  orderSent: "Order sent to the manager.",
  smsFailed: "Could not send the message. Please call the steward.",
  back: "Back to menu",
  mild: "Mild",
  medium: "Medium",
  hot: "Hot",
...
const hi: Dict = {
  ...
  waiterCalled: "वेटर को सूचित कर दिया गया है।",
  orderSent: "ऑर्डर मैनेजर को भेज दिया गया।",
  smsFailed: "संदेश नहीं भेजा जा सका। कृपया स्टीवर्ड को बुलाएँ।",
  back: "मेन्यू पर वापस",
  mild: "हल्का",
  medium: "मध्यम",
  hot: "तेज़",
